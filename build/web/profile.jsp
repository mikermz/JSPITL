                ...
                <table >
                    ...
                    <tbody>
                       ...
                       try{
                        ...
                        PreparedStatement stmt = con.prepareStatement("Select idHorario, nombreMateria,numAlumnos,idCarrera,horLunes,horMartes,horMiercoles,horJueves,horViernes,ht,hp,creditos from clase c join materia m on  m.idMateria = c.idMateria join horario h on c.idClase = h.idClase join profe p on c.idProf=p.idProf where c.idProf=?");
